...
def get_opt():
    ...
    parser.add_argument('--image_root', default='/data/wgr/data/fine-grained-data/CUB/', type=str, metavar='PATH',
    ...
    parser.add_argument('--resnet_path', default='/data/wgr/code/APN-ZSL-master/pretrained_models/resnet101_c.pth.tar',
    ...
    parser.add_argument('--con', type=float, default=0)
